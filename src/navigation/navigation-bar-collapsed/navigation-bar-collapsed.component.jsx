...
import "./navigation-bar-collapsed.styles.scss"
...
class NavigationBarCollapsed extends React.Component {
  constructor(props) {
    super(props)
  ...
  handleHover() {
    ...
    let page = document.getElementsByClassName("page")[0]
    if (page.classList.contains("toggle") && this.state.isHovered) {
      page.classList.remove("toggle")
    } else {
      page.classList.add("toggle")
    }
    let sidebar = document.getElementsByClassName("sidebar")[0]
    if (sidebar.classList.contains("active") && this.state.isHovered) {
  ...
  render() {
    ...
    return (
      <div>
        {currentUser ? (
          <div
            className={`sidebar${!this.state.isCollapsed ? " active" : ""}`}
          ...
          >
            <div className="sidebar__top">
              ...
              <img
                className={`parallax-header_logo sidebar__burger${
                  this.state.isHovered ? " hide-logo" : ""
                }`}
                src={logo}
                alt="header-logo"
                onClick={this.sidebar_click}
            ...
            <div
              className={`sidebar__top_profile profile-pic standard-padding profile-pic-collapsed${
                this.state.isHovered ? " hide-pic" : ""
              }`}
            >
              <Image
                className="sidebar__pic sidebar__pic_black"
...
export default connect(mapStateToProps)(NavigationBarCollapsed)
